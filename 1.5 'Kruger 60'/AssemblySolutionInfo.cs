...
{
    public const string DefaultAssemblyVersion = "1.5.1100.0";
    public const string AssemblyFileVersion = "1.5.1100.0";
    public const string AssemblyInformationalVersion = "1.5.1100.0";
