...
{
    public const string DefaultAssemblyVersion = "1.5.1015.0";
    public const string AssemblyFileVersion = "1.5.1015.0";
    public const string AssemblyInformationalVersion = "1.5.1015.0";
    public const string AssemblyProduct = "IPTViewr: virtual decoder for movistar+" + " (v" + ProductVersion + ")";
    public const string ProductVersion = "1.5 \"Kruger 60\" Beta 1 RTW";
